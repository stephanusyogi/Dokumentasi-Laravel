@extends('layouts.master') @section('content') @if(session('sukses'))
...
<div class="row" style="margin-top: 20px;">
    <div class="col-6">
        <h3>Sistem Informasi Akademik Siswa</h3>
        <h4>Data Siswa</h4>
    </div>
    <div class="col-6">
    ...
    <table id="datatable" class="table table-hover" style="margin-top: 30px">
    	
        <tr>
            <th>NAMA DEPAN</th>
            <th hidden="">NAMA BELAKANG</th>
            <th>JENIS KELAMIN</th>
            <th hidden="">AGAMA</th>
            <th>ALAMAT</th>
            <th>AKSI</th>
        ...
        <tr>
            ...
            <td hidden="">{{$siswa->nama_belakang}}</td>
            <td>{{$siswa->jenis_kelamin}}</td>
            <td hidden="">{{$siswa->agama}}</td>
            <td>{{$siswa->alamat}}</td>
            <td>
                <a href="/siswa/{{$siswa->id}}/detail" class="btn btn-success btn-sm">Detail</a>
                <a href="/siswa/{{$siswa->id}}/edit" class="btn btn-warning btn-sm">Edit</a>
                <a href="/siswa/{{$siswa->id}}/delete" class="btn-danger btn-sm" onclick="return confirm('Yakin Mau Dihapus ?')">Delete</a>
            </td>
        </tr>
        @endforeach
